...
lacks — charts, tiles, tables, timelines, notices, the approval card, a
code diff, a map, and a Kanban board — are kept as clearly labelled custom extensions (``source="custom"``).
Twenty-six types in all; a student can read every one and the validator can
prove coverage.
...
COMPONENTS: dict[str, ComponentSpec] = {
    ...
    "CodeDiff": ComponentSpec("CodeDiff", {
        "title": PropSpec("text"),
        "before": PropSpec("binding"),
        "after": PropSpec("binding"),
        "beforeLabel": PropSpec("text"),
        "afterLabel": PropSpec("text"),
    }, source="custom"),
    "Map": ComponentSpec("Map", {
        "title": PropSpec("text"),
        "markers": PropSpec("binding"),
    ...
    "VideoPlayer": ComponentSpec("VideoPlayer", {
        "src": PropSpec("text"),
        "caption": PropSpec("text"),
        "autoplay": PropSpec("bool"),
    }, source="custom"),
}
